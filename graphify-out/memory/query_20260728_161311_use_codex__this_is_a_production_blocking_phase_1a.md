---
type: "query"
date: "2026-07-28T16:13:11.837288+00:00"
...
outcome: "useful"
source_nodes: ["savePanel1Draft()", "migrationTracker.js", "migrate-deploy.js", "publicationService.js"]
---
...
Expanded from original query via vocab: [panel, hero, save, draft, form, route, controller, validation, transaction, migration, schema, deploy]. DFS identified savePanel1Draft(), migrationTracker.js, migrate-deploy.js, and publicationService.js. Repository and HTTP/DB validation found an incomplete legacy draft plus native required validation preventing the POST; migration 18 repairs missing draft keys from published snapshots, schema readiness now fails clearly, save is transactional and verified, and centralized publication no longer writes invalid entityId 0 revisions. Focused suites and full serial suite pass.
