...
describe('Phase 1C — Regression', () => {
  ...
  it('47. module registry includes 10 modules (Phase 2A added SOCIAL_FEED)', () => {
  ...
  it('54. migration tracker has 25 entries (Phase 2B added homepage Social Feed settings)', () => {
